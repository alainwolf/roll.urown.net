...
SECRET_KEY = 'qEqvGcqgyFeTGbaHijhVCjteMXRNjxhQKn4tCwDguDZGpxFrVycv3NQNhgDvxJqg'
...
WHISPER_DIR = '/opt/grapite/storage/whisper'
RRD_DIR = '/opt/graphite/storage/rrd'
DATA_DIRS = [WHISPER_DIR, RRD_DIR] # Default: set from the above variables
LOG_DIR = '/var/log/graphite'
INDEX_FILE = '/opt/graphite/search_index'  # Search index file
...
DATABASES = {
    'default': {
        ...
        'USER': 'graphite',
        'PASSWORD': 'qB5nZTWmxRAxpBbaw9tHziz2',
        'HOST': 'localhost',
        'PORT': '3306'
    }
}
