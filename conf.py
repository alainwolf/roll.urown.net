...
manpages_url = (
    "https://manpages.ubuntu.com/manpages/jammy/en/man{section}/{page}.{section}.html"
)
...
man_pages = [
    ("index", "roll.urown.net", "Roll Your Own Network", ["roll.urown.net"], 1)
]
...
texinfo_documents = [
    (
        ...
        "roll.urown.net",
        "roll.urown.net",
        "How to Roll Your Own Network Services.",
        "Privacy",
    ),
]
